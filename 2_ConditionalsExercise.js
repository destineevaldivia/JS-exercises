...
//console.log(exercise4(0,0)); //expect: equal
//console.log(exercise4(1,"1")); //expect: equal
//console.log(exercise4(1,"2")); //expect: differ
//console.log(exercise4(1, 2)); //expect: differ
//console.log(exercise4("one","two")); //expect: differ
//console.log(exercise4("one","one")); //expect: equal
  ...
  // consider other data types beside strings and variables.
    //Answer: Since I chose to compare the values using the equality operator (==) instead of the strict equlaity operator (===),
    //when the function is called with (VarA, VarB) as (1 and "1"), respectively, it will evaluate to true 
    //aka. `${varA} and ${varB} are equal` because the equality operator compares values even if they are different dataTypes. 
    //In this example, VarA dataType is a number and VarB dataType is a string. Even so, Javascript will perform type coersion to compare them. 
    //In other words, they are loosely equal.
    //If I would have used strictly equal, this same example would be false and evaluate to `${varA} and ${varB} differ` because they are different dataTypes.
  ...
  //console.log(exercise6(1,1,1)); //expect: false
  //console.log(exercise6(1,1,2)); //expect: true
...
//console.log(exercise8(2, 4, 1, 10)); //expect: true
//console.log(exercise8(12, 4, 1, 10)); //expect: false
//console.log(exercise8(1, 4, 1, 10)); //expect: false
...
//   console.log(exercise10(2)); // 2
  ...
  // Please answer in a comment below.
    //#1-7 were easy, #8-10 were more challenging, but still doable with more thinking.
    //I used my notes from FreeCodeCamp, MDN to check TypeOf syntax, and chatGPT when I couldnt find an error with the bracket placement.
